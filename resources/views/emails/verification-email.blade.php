			...
			<tr>
				<td style="padding: 20px 0 40px;text-align: center;">
					<div class="container" style="max-width: 100%;margin:0 auto;">
						<a href="#">
							<img src="{{asset('assets/frontend/image/header-logo.png')}}"
				...
				<td>
					<div class="container" style="max-width: 100%;margin:0 50px;">
						...
						<a href="{{url('verify', $email_token)}}"
							style="color: #FBFCFF; font-family: 'Poppins', sans-serif; font-size: 18px;  line-height: 24px;">{{url('verify', $email_token)}}</a>
						...
						<div style="display:flex;justify-content:space-between;">
							...
							<div style="display:flex;align-items:center;">
								...
								<a href="#">
									...
									<img src=" {{asset('assets/frontend/image/telegram.png')}}" alt="telegram-logo"
