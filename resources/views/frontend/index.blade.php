...
<div class="index-page">
	...
	<div class="col-md-6">
		{{-- <div class="hero-right">
			<div class="slide-logo text-center mb-5 wow fadeInDown animated">
				<img src="{{asset('assets/frontend/image/logo-medium.png')}}" alt="logo" class="" title="">
	</div>
	<div class="hero-progress wow fadeInDown animated">
		<div class="d-flex align-items-center justify-content-end hero-progressbar first-bar" data-percentage="10%">
			<p>Investment</p>
		...
		<div class="d-flex align-items-center mt-5 justify-content-end hero-progressbar" data-percentage="20%">
			<p>Max. perform</p>
		...
		<div class="d-flex align-items-center mt-5 justify-content-end hero-progressbar" data-percentage="30%">
			<p>Risk</p>
			<input id="ex10" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="100"
				data-slider-step="1" data-slider-value="700" />
		</div>
		<div class="d-flex align-items-center mt-5 justify-content-end hero-progressbar" data-percentage="40%">
			<p>Max. loss</p>
			<input id="ex11" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="100"
				data-slider-step="1" data-slider-value="900" />
		</div>
	</div>
...
<div class="hero-right">
	<div class="slide-logo text-center mb-3 wow fadeInDown animated">
		<img src="{{asset('assets/frontend/image/altbot-logoIcon-white.svg')}}" alt="logo" class="" title="">
	</div>
	<div class="hero-progress wow fadeInDown animated">
...
<section class="site-quote">
	<div class="container">
		<div class="quote-box d-flex">
			<img src="{{asset('assets/frontend/image/maris.png')}}" alt="quote-img" title="" class="quote-img">
...
<section class="site-chart">
	...
	<div class="chart-table">
		...
		{{-- <div id="tooltip_rotated" style="height: 400px;"></div> --}}
		{{-- <img src="{{asset('assets/frontend/image/chart.jpg')}}" alt="chart" title="" class=""> --}}
			...
			<div class="row">
				<div class="col-md-3 brokers-box">
					...
					<a href="" class="d-flex justify-content-center align-items-center brokers-img"><img
							src="{{asset('assets/frontend/image/ig@2x.png')}}" class="" alt="brokers-logo-1"
							title=""></a>
				...
				<div class="col-md-3 brokers-box">
					...
					<a href="" class="d-flex justify-content-center align-items-center brokers-img"><img
							src="{{asset('assets/frontend/image/axi@2x.png')}}" class="" alt="brokers-logo-2"
							title=""></a>
		...
		<div class="points-column">
			<div class="points-box">
				<div class="row align-items-end">
					<div class="col-md-6 col-left">
						<div class="point-img">
							<img src="{{asset('assets/frontend/image/player-controls.png')}}" alt="player-controls"
								title="" class="">
						</div>
					</div>
			...
			<div class="points-box">
				<div class="row align-items-center">
					<div class="col-md-6 col-left">
						<div class="point-img">
							<img src="{{asset('assets/frontend/image/artificial_intelligence.png')}}"
			...
			<div class="points-box">
				<div class="row align-items-center">
					<div class="col-md-6 col-left">
						<div class="point-img">
							<img src="{{asset('assets/frontend/image/innovation.png')}}" alt="innovation" title=""
								class="">
						</div>
					</div>
					<div class="col-md-6 col-right">
...
<section class="site-pricing">
	<img src="{{asset('assets/frontend/image/pricing-bg.png')}}" alt="" class="" title="">
			...
			<div class="pricing-bottom d-flex align-items-center justify-content-end">
				...
				<div class="price-right">
					<div class="btn-bg pricing-btn">
						@if(Auth::check())
						<a href="{{route('frontend.dashboard')}}">Start now</a>
						@else
						<a href="{{route('frontend.login')}}">Start now</a>
						@endif
					</div>
				</div>
			</div>
...
<script>
	$('#get-bot').click(function(e) {
		...
		if (auth) {
			window.location.href = '{{route("frontend.dashboard")}}'; //using a named route
		} else {
			window.location.href = '{{route("frontend.register")}}'; //using a named route
		}
	});
</script>
