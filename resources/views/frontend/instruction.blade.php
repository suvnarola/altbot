        ...
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-4.png')}}" alt="telegram-logo" title=""
        ...
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-5.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-6.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-7.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-8.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
            ...
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <h2 class="wow zoomIn animated">Open charts for the following instruments by Right click in the Market watch panel:<br />
                        ...
                        <h2>EUR/NZD</h2>
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-9.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-10.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-11.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-12.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-13.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
        <div class="work-1 work-step">
            <div class="work-box">
                <div class="sec-title">
                    ...
                    <br />
                    <img src="{{asset('assets/frontend/image/instructions/step-14.png')}}" alt="telegram-logo" title=""
                        class="telegram-logo" style="max-width: 50%;">
                </div>
            </div>
        </div>
