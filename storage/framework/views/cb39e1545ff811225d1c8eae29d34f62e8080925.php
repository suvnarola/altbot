		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				<div class="content">
					...
					<!-- /page header -->
					<form method="post" action="<?php echo e(action('BlogController@update', $blog->id)); ?>">
						...
						<div class="panel panel-flat">
							<div class="panel-body">
								...
								<div class="form-group">
									<label>Title:</label>
									<input type="text" value="<?php echo e($blog->title); ?>" name="title" class="form-control"
										placeholder="">
								</div>

								<div class="form-group">
									<label>Tags:</label>
									<input type="text" value="<?php echo e($blog->tags); ?>" name="tags"
								...
								<div class="form-group ">
									<div class="input-group col-md-4">
										...
										<input name="date" type="text" class="form-control daterange-single"
								...
								<div class="form-group">
									...
									<label class="radio-inline">
										<input type="radio" name="status" value="1" class="styled" <?php echo  ($blog->status === 1) ? "checked" : "" ?>>
										Published
									</label>
									<label class="radio-inline">
										<input type="radio" name="status" value="0" class="styled" <?php echo ($blog->status === 0) ? "checked" : "" ?>>
										Draft
									</label>
								</div>
								<div class="text-left">
