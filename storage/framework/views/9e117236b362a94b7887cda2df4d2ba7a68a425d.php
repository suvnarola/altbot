		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="page-header page-header-default">
						...
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
                                ...
                                <li><a href="<?php echo e(route('users.changeConfig')); ?>">Paypal</a></li>
					...
					<form method="POST" action="<?php echo e(route('users.updateConfig')); ?>">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" name="PAYPAL_CLIENT_ID" class="form-control" placeholder=""
										value="<?php echo e(\Config::get('paypal')['client_id']); ?>">
								</div>

								<div class="form-group">
									<label>Paypal Secret:</label>
									<input type="text" name="PAYPAL_SECRET" class="form-control" placeholder=""
										value="<?php echo e(\Config::get('paypal')['secret']); ?>">
								</div>
								<?php 
								...
								<div class="form-group">
									...
									<select class="form-control" name="PAYPAL_MODE">
										<option value="live" <?php echo e(($paypal_mode == 'live') ? 'selected' : ''); ?>>Live
										</option>
										<option value="sandbox" <?php echo e(($paypal_mode == "sandbox") ? 'selected' : ''); ?>>
											Sandbox</option>
									</select>
								</div>
								<div class="text-left">
