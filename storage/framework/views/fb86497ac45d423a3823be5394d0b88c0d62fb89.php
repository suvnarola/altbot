<meta charset="utf-8">
	...
	<script type="text/javascript" src="<?php echo e(asset('assets/js/plugins/uploaders/fileinput.min.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('assets/js/pages/uploader_bootstrap.js')); ?>"></script>
	...
	<script type="text/javascript" src="<?php echo e(asset('assets/js/pages/picker_date.js')); ?>"></script>
