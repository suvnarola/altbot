                ...
                <div class="content">
                    ...
                    <div class="page-header page-header-default">
                        ...
                        <div class="page-header-content">
                            ...
                            <div class="page-title">
                                ...
                                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Zip
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <legend class="text-bold">Compiled File</legend>
                            <?php 

                            $id = Request::segment(4);;

                             ?>
                            <form method="POST" action="/admin/user/upload-zip" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $id?>">
                                <div class="form-group">

                                    <label class="col-lg-2 control-label text-semibold">Compiled File:</label>

                                    <div class="col-lg-10">

                                        <input type="file" name="zip" class="file-input">
                                        ...
                                        <span class="help-block"><code><a href="<?php echo e(asset($path)); ?>" target="_blank"><?php echo e($files['csv1']); ?></code></a></span>

                                        <?php else: ?>

                                        <span class="help-block"><code><a href="}" target="_blank">No File Chosen</code></a></span>
                                        ...
                                        <span class="help-block alert alert-success"><?php echo e(session('success_single_csv1')); ?></span>
